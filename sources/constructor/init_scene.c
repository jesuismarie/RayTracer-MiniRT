...
/*   Updated: 2024/06/07 21:06:34 by mnazarya         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	init_scene(t_scene **scene)
{
	...
	(*scene)->figure->next->sph = new_sphere(new_vector(2, 1, -50), 2);
	...
	(*scene)->figure->next->next->sph = new_sphere(new_vector(7, 0, -50), 1);
	...
	(*scene)->figure->next->next->next->next->cyl = \
		new_cylinder(new_vector(0, 0, -20), norm, 2, 5);
	// -------------- Cone ----------------
