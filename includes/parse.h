...
/*   Updated: 2024/06/11 01:10:42 by gehovhan         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
typedef enum e_check_type				t_check_type;
...
bool			ft_create_camera(t_scene *scene, t_list_token	*list, \
														char **error);
bool			ft_parse_camera(t_list_token *list, t_camera *camera, \
														char **error);
...
bool			ft_create_amb_light(t_scene *scene, t_list_token	*list, \
															char **error);
bool			ft_validate_plane(t_list_token *list, char **error);
bool			ft_is_near_equal(double num, double num2);
bool			ft_is_within_range(double value, double lower_bound, \
												double upper_bound);
bool			ft_is_in_range_int(int num, int min, int max);
bool			ft_is_within_range_weak(double value, double lower_bound, \
													double upper_bound);
...
int				ft_tokenize_delim_helper(t_tokenize_wrap *wrap, \
										t_ptoken_type *type);
char			*ft_tokenize_with_delims(char *str, t_ptoken_type *type);
char			*ft_parse(t_scene *scene, char **argv);
bool			ft_parse_object(t_scene *scene, t_list_token	*list, \
														char **error);
...
bool			ft_create_object(t_scene *scene, t_list_token	*list, \
														char **error);
...
bool			ft_create_light(t_scene *scene, t_list_token *list, \
													char **error);
bool			ft_validate_color_args(t_token *start, t_token *end, \
													char **error);
...
bool			ft_create_plane(t_scene *scene, t_list_token	*list, \
														char **error);
bool			ft_parse_plane(t_list_token *list, t_plane *plane, \
													char **error);
bool			ft_validate_plane_args(t_plane plane, char **error);
bool			ft_skip_optional_arg(t_list_token *list, t_token **start, \
										char **error, int max_ops_arg);
bool			ft_validate_sphere(t_list_token *list, char **error);
bool			ft_create_sphere(t_scene *scene, t_list_token	*list, \
														char **error);
bool			ft_validate_cylinder(t_list_token *list, char **error);
bool			ft_create_cylinder(t_scene *scene, t_list_token	*list, \
														char **error);
