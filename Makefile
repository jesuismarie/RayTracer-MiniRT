...
${NAME}:		${OBJS}
	...
	@echo "$(ORANGE)----------------------------------------------------$(RESET)"
	@echo "$(ORANGE)| Recommended Scenes | scenes/room.rt              |$(RESET)"
	@echo "$(ORANGE)|                    | scenes/white.rt             |$(RESET)"
	@echo "$(ORANGE)|                    | scenes/billiard.rt          |$(RESET)"
	@echo "$(ORANGE)|                    | scenes/snowman.rt           |$(RESET)"
	@echo "$(ORANGE)|                    | scenes/solar.rt             |$(RESET)"
	@echo "$(ORANGE)|                    | scenes/atom.rt              |$(RESET)"
	@echo "$(ORANGE)|                    | scenes/octagone.rt          |$(RESET)"
	@echo "$(ORANGE)|                    | scenes/complex.rt           |$(RESET)"
	@echo "$(ORANGE)|                    | scenes/abstract.rt          |$(RESET)"
	@echo "$(ORANGE)|                    | scenes/spheres.rt           |$(RESET)"
	@echo "$(ORANGE)----------------------------------------------------$(RESET)"
